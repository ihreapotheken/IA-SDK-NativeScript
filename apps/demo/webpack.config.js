    ...
    config.plugin('define-secrets').use(DefinePlugin, [
      {
        ...
        // Same variable that stamps the launcher label in dev-env-setup.sh, so the environment
        // shown on the icon is always the one the SDK is actually initialised against.
