...
export class IaSdk extends Observable {
   ...
   */
  setGuestUserData(salutation: IaSdkBase.Salutation, firstName: string, lastName: string, email: string, phoneNumberCountryCode: number, phoneNumberWithoutCountryCode: number): Promise<void> {
    return new Promise((resolve, reject) => {
      if (isAndroid) {
        IaSdkAndroid.instance.setGuestUserData(salutation, firstName, lastName, email, phoneNumberCountryCode, phoneNumberWithoutCountryCode, (e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
      ...
      if (isIOS) {
        IaSdkIOS.instance.setGuestUserData(salutation, firstName, lastName, email, phoneNumberCountryCode, phoneNumberWithoutCountryCode, (e: any) => {
          if (e == null) {
            resolve();
          } else {
            reject(e);
   ...
   */
  transferPrescriptions(images: Array<string> | null, pdfs: Array<string> | null, codes: Array<string> | null, orderId: string | null): Promise<void> {
    return new Promise((resolve, reject) => {
      if (isAndroid) {
        IaSdkAndroid.instance.transferPrescriptions(images, pdfs, codes, orderId, (e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
      ...
      if (isIOS) {
        IaSdkIOS.instance.transferPrescriptions(images, pdfs, codes, orderId, (e: any) => {
          if (e == null) {
            resolve();
          } else {
            reject(e);
  ...
  startDashboardActivity(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      if (isAndroid) {
        IaSdkAndroid.instance.startDashboardActivity((e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
  ...
  finishAllActivities(): Promise<void> {
    return new Promise((resolve, reject) => {
      if (isAndroid) {
        IaSdkAndroid.instance.finishAllActivities((e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
      ...
      if (isIOS) {
        IaSdkIOS.instance.finishAllActivities((e: any) => {
          if (e == null) {
            resolve();
          } else {
            reject(e);
  ...
  logout(): Promise<void> {
    return new Promise((resolve, reject) => {
      if (isAndroid) {
        IaSdkAndroid.instance.logout((e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
      ...
      if (isIOS) {
        IaSdkIOS.instance.logout((e: any) => {
          if (e == null) {
            resolve();
          } else {
            reject(e);
  ...
  clearCart(): Promise<void> {
    return new Promise((resolve, reject) => {
      if (isAndroid) {
        IaSdkAndroid.instance.clearCart((e: any) => {
          if (e == 'success') {
            resolve();
          } else {
            reject(e);
      ...
      if (isIOS) {
        IaSdkIOS.instance.clearCart((e: any) => {
          if (e == null) {
            resolve();
          } else {
            reject(e);
