...
interface OS_xpc_peer_requirement extends NSObjectProtocol {
}
declare var OS_xpc_peer_requirement: {

	prototype: OS_xpc_peer_requirement;
};
 ...
 * @since 26.0
 */
declare function xpc_connection_set_peer_requirement(connection: NSObject & OS_xpc_object, peer_requirement: NSObject & OS_xpc_peer_requirement): void;
 ...
 * @since 26.0
 */
declare function xpc_listener_set_peer_requirement(listener: NSObject & OS_xpc_listener, requirement: NSObject & OS_xpc_peer_requirement): void;
 ...
 * @since 26.0
 */
declare function xpc_peer_requirement_create_entitlement_exists(entitlement: string | interop.Pointer | interop.Reference<any>, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): NSObject & OS_xpc_peer_requirement;

/**
 * @since 26.0
 */
declare function xpc_peer_requirement_create_entitlement_matches_value(entitlement: string | interop.Pointer | interop.Reference<any>, value: NSObject & OS_xpc_object, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): NSObject & OS_xpc_peer_requirement;

/**
 * @since 26.0
 */
declare function xpc_peer_requirement_create_lwcr(lwcr: NSObject & OS_xpc_object, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): NSObject & OS_xpc_peer_requirement;

/**
 * @since 26.0
 */
declare function xpc_peer_requirement_create_platform_identity(signing_identifier: string | interop.Pointer | interop.Reference<any>, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): NSObject & OS_xpc_peer_requirement;

/**
 * @since 26.0
 */
declare function xpc_peer_requirement_create_team_identity(signing_identifier: string | interop.Pointer | interop.Reference<any>, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): NSObject & OS_xpc_peer_requirement;

/**
 * @since 26.0
 */
declare function xpc_peer_requirement_match_received_message(peer_requirement: NSObject & OS_xpc_peer_requirement, message: NSObject & OS_xpc_object, error_out: interop.Pointer | interop.Reference<NSObject & OS_xpc_object>): boolean;
 ...
 * @since 26.0
 */
declare function xpc_session_set_peer_requirement(session: NSObject & OS_xpc_session, requirement: NSObject & OS_xpc_peer_requirement): void;
