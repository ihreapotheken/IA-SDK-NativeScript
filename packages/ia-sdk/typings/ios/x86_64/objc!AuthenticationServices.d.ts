...
declare class ASCredentialProviderExtensionContext extends NSExtensionContext {
   ...
   * @since 26.2
   */
  completeGeneratePasswordRequestWithResultsCompletionHandler(results: NSArray<ASGeneratedPassword> | ASGeneratedPassword[], completionHandler: (p1: boolean) => void): void;
   ...
   * @since 26.2
   */
  completeSavePasswordRequestWithCompletionHandler(completionHandler: (p1: boolean) => void): void;
}
...
declare class ASGeneratePasswordsRequest extends NSObject implements NSCopying, NSSecureCoding {
  ...
  constructor(o: { serviceIdentifier: ASCredentialServiceIdentifier; passwordFieldPasswordRules: string; confirmPasswordFieldPasswordRules: string; passwordRulesFromQuirks: string });
  ...
  initWithServiceIdentifierPasswordFieldPasswordRulesConfirmPasswordFieldPasswordRulesPasswordRulesFromQuirks(serviceIdentifier: ASCredentialServiceIdentifier, passwordFieldPasswordRules: string, confirmPasswordFieldPasswordRules: string, passwordRulesFromQuirks: string): this;
}
...
declare class ASSavePasswordRequest extends NSObject implements NSCopying, NSSecureCoding {
  ...
  constructor(o: { serviceIdentifier: ASCredentialServiceIdentifier; credential: ASPasswordCredential; sessionID: string; event: ASSavePasswordRequestEvent; passwordKind: string });

  constructor(o: { serviceIdentifier: ASCredentialServiceIdentifier; credential: ASPasswordCredential; title: string; sessionID: string; event: ASSavePasswordRequestEvent });

  constructor(o: { serviceIdentifier: ASCredentialServiceIdentifier; credential: ASPasswordCredential; title: string; sessionID: string; event: ASSavePasswordRequestEvent; passwordKind: string });
  ...
  initWithServiceIdentifierCredentialSessionIDEventPasswordKind(serviceIdentifier: ASCredentialServiceIdentifier, credential: ASPasswordCredential, sessionID: string, event: ASSavePasswordRequestEvent, passwordKind: string): this;

  initWithServiceIdentifierCredentialTitleSessionIDEvent(serviceIdentifier: ASCredentialServiceIdentifier, credential: ASPasswordCredential, title: string, sessionID: string, event: ASSavePasswordRequestEvent): this;

  initWithServiceIdentifierCredentialTitleSessionIDEventPasswordKind(serviceIdentifier: ASCredentialServiceIdentifier, credential: ASPasswordCredential, title: string, sessionID: string, event: ASSavePasswordRequestEvent, passwordKind: string): this;
}
