...
declare class SFSafariExtensionManager extends NSObject {
  ...
  static getStateOfExtensionWithIdentifierCompletionHandler(identifier: string, completionHandler: (p1: SFSafariExtensionState, p2: NSError) => void): void;
...
declare class SFSafariSettings extends NSObject {
   ...
   * @since 26.2
   */
  static openExtensionsSettingsForIdentifiersCompletionHandler(extensionIdentifiers: NSArray<string> | string[], completionHandler: (p1: NSError) => void): void;
}
