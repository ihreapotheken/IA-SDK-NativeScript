...
interface _OSUnalignedU16 {
	__val: number;
}
declare var _OSUnalignedU16: interop.StructType<_OSUnalignedU16>;

interface _OSUnalignedU32 {
	__val: number;
}
declare var _OSUnalignedU32: interop.StructType<_OSUnalignedU32>;

interface _OSUnalignedU64 {
	__val: number;
}
declare var _OSUnalignedU64: interop.StructType<_OSUnalignedU64>;
...
interface arm_state_hdr {
	flavor: number;
	count: number;
}
declare var arm_state_hdr: interop.StructType<arm_state_hdr>;
...
interface hv_data_abort_notification_t {
	context: number;
	ipa: number;
	value: number;
	access_size: number;
...
declare var hv_data_abort_notification_t: interop.StructType<hv_data_abort_notification_t>;

interface hv_vm_mem_access_msg_t {
	header: mach_msg_header_t;
	body: hv_data_abort_notification_t;
}
declare var hv_vm_mem_access_msg_t: interop.StructType<hv_vm_mem_access_msg_t>;
...
declare var processor_cpu_stat: interop.StructType<processor_cpu_stat>;

interface processor_cpu_stat64 {
	irq_ex_cnt: number;
	ipi_cnt: number;
	timer_cnt: number;
	undef_ex_cnt: number;
...
declare var processor_cpu_stat64: interop.StructType<processor_cpu_stat64>;
...
interface task_basic_info_64_2 {
	suspend_count: number;
	virtual_size: number;
	resident_size: number;
	user_time: time_value;
...
declare var task_basic_info_64_2: interop.StructType<task_basic_info_64_2>;
